...
return [
    ...
    */
    ...
    'meta_description' => 'Οι «Ταξιδιώτες» είναι ένα διαδικτυακό παιχνίδι ειδικά σχεδιασμένο για παιδιά με αναπηρία.',
    'meta_logo_image_alt' => 'Λογότυπο του παιχνιδιού «Ταξιδιώτες»',
    'game_note' => 'Το παιχνίδι είναι σχεδιασμένο για να παίζεται σε ηλεκτρονικό υπολογιστή. Έτσι μπορεί να προσαρμοστεί στις ανάγκες των παιδιών με εγκεφαλική παράλυση.',
    /* Footers */
    'contact_us' => 'Επικοινώνησε μαζί μας',
    'follow_us' => 'Ακολούθησέ μας',
    'follow_us_on' => 'Ακολούθησέ μας στο :network',
    'development' => 'Ανάπτυξη',
    'developed_by' => 'Αναπτύχθηκε από',
    'sponsored_by' => 'Ευγενική χορηγία',
    'developer_logo_alt' => 'SciFY - Science for You',
    'sponsor_logo_alt' => 'Ηρακλής - Όμιλος εταιριών',
    /* Generic */
