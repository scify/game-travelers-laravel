...
>
    {{-- This page was designed responsively in order to support any amount of
         ...
         --}}
    @section('scripts')
        <x-switcher :switcher=$switcher :audio="'sounds.game_start.pawn_onload'" :music="'music.feelin_good'" />
    @endsection

    <form method="post"
        action="{{ route('select.pawn', [ request()->player_id, request()->game_id ]) }}"
    >
        @csrf
                ...
                <div class="col-12">
                    <div class="d-flex flex-auto mt-4 mt-sm-0">
                        <a
                            ...
                            href="{{ route('select.mode', [ request()->player_id, request()->game_id ])}}"
                            id="backButton"
                            data-tabindex="1000"
                        >
                            <span>πίσω</span>
