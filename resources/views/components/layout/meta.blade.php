...
<meta name="og:description" property="og:description" content="{{ $description ?? __('messages.meta_description') }}">
...
<meta name="twitter:description" content="{{ $description ?? __('messages.meta_description') }}">
<meta name="twitter:image" content="{{ asset('images/taxidiotes_logo.webp') }}">
<meta name="twitter:image:alt" content="{{ __('messages.meta_logo_image_alt')}}">
<meta name="twitter:creator" content="@SciFY_org">
