<x-layout :title="'Νέο παιχνίδι ή συνέχεια προηγούμενου; | Ταξιδιώτες'" :hasUserMenu=true :background="'background-dash-up'">
    ...
    <form method="post"
        action="%PLACEHOLDER%" {{-- dont forget the back button! --}}
    >
        @csrf
