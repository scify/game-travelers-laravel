...
<body>
    <div class="container">
        ...
        <dl>
            ...
            <dd>✔️ <span class="new">New</span> Step 1. Fully responsive. Avatars have been reduced in size to fit this screen, labels have been introduced and everything acts as a virtual radiogroup with radios that is fully accessible. Custom flex-grid to allow trees to grow. The dash line at the bottom runs very wild. <span class="todo">TODO</span>: Remove player has been removed and will go to Settings. A secondary button was created. There is no way to log-out until the user has selected a Player. Fully responsive.</span>
            ...
            <dd>✔️ <span class="new">New</span> Step 2. Select board. Fully responsive. Supports 1 to N amount of boards where N equals to the integer limit of the MySQL database. Extra attention to detail has been give to have buttons with strong and distinctive hover, focus and active states based on combinations of shadows. Bonus: ΠΡΟΣΕΧΩΣ! for unreleased boards. This is the suggested version, using direct links with GET parameters. As always the documentation has been added in the template.</span>
                <dl>
                    ...
                    <dd>✔️ <span class="new">New</span> Step 2 based on a get/post FORM with buttons & hidden fields.</span>
                </dl>
            ...
            <dd>✔️ <span class="new">New</span> Step 4. Different orientation of "options" demanded another new element, the pawn button. Same instructions as the ones above. Fully responsive. </span>
            <dt><a href="{{ url('/select/options') }}">New game: Select options (5 or 4/5)</a></dt>
            <dd>✔️ <span class="new">New</span> Step 5. Start tutorial or Start game? That's the question. Uses the same components as the ones on the previous steps. Same guidelines for passing selected options. Fully responsive. An option can be disabled via :comingsoon and of course no teaser is added. Responsive as well.</span>
        </dl>
